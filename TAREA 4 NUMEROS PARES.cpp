...
//este es el metodo dos que tuve que utilizar porque el metodo uno consistia en una gran cantidad de variables y utilizar la funcion IF /ELSE// TENIENDO PROBELMAS
